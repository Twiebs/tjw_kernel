...
Error_Code storage_device_initialize(Storage_Device *device);
Error_Code storage_device_read(Storage_Device *device, uint64_t block_number, uint64_t block_count, uint8_t *buffer);