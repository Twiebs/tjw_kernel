...
gcc $COMPILER_FLAGS -m64 -mno-red-zone -nostdlib -ffreestanding -fno-stack-protector -I $KERNEL_SOURCE_DIRECTORY -c $KERNEL_SOURCE_DIRECTORY/single_translation_unit_build.c -o $BINARY_OUTPUT_DIRECTORY/single_translation_unit_build.c.o
...
ld -melf_x86_64 -n -T $KERNEL_SOURCE_DIRECTORY/kernel_link.ld -o $BINARY_OUTPUT_DIRECTORY/kernel $BINARY_OUTPUT_DIRECTORY/single_translation_unit_build.c.o $BINARY_OUTPUT_DIRECTORY/x86_64_entry.asm.o $BINARY_OUTPUT_DIRECTORY/primary_cpu_init.asm.o
